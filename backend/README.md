...
## Project Structure
    ...
    ├── testapiautoteammemb_70536  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_70536`
...
2. Clone this repo and `cd testapiautoteammemb_70536`
